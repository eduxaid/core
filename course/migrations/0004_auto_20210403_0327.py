# Generated by Django 3.1.7 on 2021-04-02 20:27
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('course', '0003_auto_20210402_2241'),
    ]
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='category',
            name='parent',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='course.category', verbose_name='Parent Category'),
        ),
        migrations.AlterField(
            model_name='category',
            name='slug',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('audience', ckeditor.fields.RichTextField(blank=True, null=True)),
                ...
                ('price', djmoney.models.fields.MoneyField(decimal_places=2, default_currency='IDR', max_digits=10)),
                ('status', models.CharField(choices=[('DRAFT', 'DRAFT'), ('PUBLISHED', 'PUBLISHED'), ('REJECTED', 'REJECTED'), ('WAITING_FOR_REVIEW', 'WAITING FOR REVIEW')], default='DRAFT', max_length=20)),
